...
class MallMap:
    ...
    def add_connection(self, store1: str, store2: str, distance: float):
        ...
        # Add or update the connection, always checking for the shortest path
        current_distance = self.stores[store1].get(store2, float('inf'))
